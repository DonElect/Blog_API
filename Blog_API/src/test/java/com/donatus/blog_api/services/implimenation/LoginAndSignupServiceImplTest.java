...
class LoginAndSignupServiceImplTest {
    ...
    void registerUser() {
        ...
        String savedUser = service.registerUser(signupDTO);
    ...
    @Test
    void removeUser() {
        org.junit.jupiter.api.Assertions.assertAll(() -> service.removeUser("USA1234D5678C900"));
    }

    @Test
    void userDetails() {
        when(userRepository.findById(Mockito.anyString())).thenReturn(Optional.ofNullable(user1));

        UserResponseDTO foundUser = service.userDetails("USA1234D5678C900");
