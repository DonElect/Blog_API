...
class LoginAndSignupControllerTest {
    ...
    void signUp() throws Exception{
        when(loginAndSignupServices.registerUser(Mockito.any(SignupDTO.class))).thenReturn("Check your email and complete your registration");
        ...
        MockMvcBuilders.standaloneSetup(controller)
                ...
                .andExpect(MockMvcResultMatchers.content()
                        .string("Check your email and complete your registration"));
    }
    ...
    void viewUser() throws Exception {
        ...
        when(loginAndSignupServices.userDetails(Mockito.anyString())).thenReturn(responseDTO);
        ...
        MockMvcBuilders.standaloneSetup(controller)
                ...
                .andExpect(MockMvcResultMatchers.content().contentType("application/json"))
                .andExpect(MockMvcResultMatchers.content()
                        .string("{\"userId\":\"USA1234D5678C900\",\"firstName\":\"Jane\"," +
                                "\"lastName\":\"Mary\",\"email\":\"mary@gmail.com\",\"userName\":\"Mary\",\"location\":\"Lagos State\"}"));
    }

    @Test
    void deleteUser() throws Exception {
        doNothing().when(loginAndSignupServices).removeUser(Mockito.anyString());
